...
public class Popstar extends Creature{
    ...
    public Popstar (String name, String information, Level.Room currentRoom, Player player){
    ...
    public void move(){
        ...
        int dNeighborsSize = neighbors.size();
    ...
    private ArrayList<Level.Room> possibleMoves(ArrayList<Level.Room> nearPlayer, ArrayList<Level.Room> neighbors) {
        ...
        for (int a = 0; a < nearPlayer.size(); a++){
            for (int b = 0; b < neighbors.size(); b++){
                ...
                Level.Room pop = neighbors.get(b);
                if (p.equals(pop)){
                    newNeighbors.remove(pop);
                }
            }
        }
